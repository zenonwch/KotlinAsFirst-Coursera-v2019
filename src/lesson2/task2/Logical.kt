...
fun isNumberHappy(number: Int): Boolean {
    ...
    return strValue[0].toInt() + strValue[1].toInt() == strValue[2].toInt() + strValue[3].toInt()
}
...
): Boolean = r2 - sqrt((x2 - x1).pow(2) + (y2 - y1).pow(2)) >= r1
...
fun brickPasses(a: Int, b: Int, c: Int, r: Int, s: Int): Boolean =
    listOf(a, b, c).sorted().let { (it[0] <= r && it[1] <= s) || (it[0] <= s && it[1] <= r) }
